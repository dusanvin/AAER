export let aaer_geschichte = [

	{
		...
		items: [
			{
				name: "1. Kongruenz mit den fachspezifischen Zielen des Lehrplans",
			...
			{
				name: "2. Kongruenz mit den fachspezifischen Kompetenzen des Lehrplans",
			...
			{
				name: "3. Kongruenz mit den fachspezifischen Inhaltsfeldern des Lehrplans",
	...
	
	{
		...
		items: [
			{
				name: "4. Trennung von historischer (Sach-)information und Deutung/Wertung",
			...
			{
				name: "5. Verfassungskonforme, antidiskriminierende Geschichtsbilder",
	...
	
	{
		...
		items: [
			{
				name: "6. Wissenschaftsorientierung",
			...
			{
				name: "7. Quellen-/Methodenorientierung",
			...
			{
				name: "8. Multiperspektivität i. e. S.",
			...
			{
				name: "11. Gegenwarts-/Zukunftsorientierung",
	...
	
	{
		...
		items: [
			{
				name: "12. Unterscheidungen von historischen Quellen und Darstellungen",
			...
			{
				name: "13. Charakter der historischen Quellen",
			...
			{
				name: "14. Charakter der Darstellungen",
			...
			{
				name: "15. Methode der (Re-)Konstruktion von Geschichte (Quellenarbeit)",
			...
			{
				name: "16. Methode der Dekonstruktion vorhandener Darstellungen",
			...
			{
				name: "17. Methode des Historischen Vergleichs",
	...
	
	{
		...
		items: [
			{
				name: "18. Kumulation von historischen Wissensdimensionen",
			...
			{
				name: "19. Progression und Transfer/Anwendung von historischen Kompetenzen",
	...
	
	{
		...
		items: [
			 {
				name: "20. Narrative Struktur und Sprache",
			...
			{
				name: "21. Fachvokabular und Begriffe",
			...
			{
				name: "22. Fachspezifische Bildfunktion",
			...
			{
				name: "23. Fachspezifische Paratexte/Hilfsdiskurse",
	...
	
	{
		...
		items: [
			{
				name: "24. Aktivierende gegenwartsrelevante, historische Leitfragen als Lernimpuls",
			...
			{
				name: "25. Sequenzierung und Angemessenheit des historischen Aufgabensettings",
			...
			{
				name: "26. Materiell-Methodische Schwerpunktsetzung des historischen Aufgabensettings",
