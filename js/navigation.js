...
let surveyTextDe = [
		...
		{
			title: "Bezüge Curriculum (Dimension 1: Anlehnung an Curriculum und Bildungsstandards)",
		...
		{
			title: "Bezüge Bildungsstandards (Dimension 1: Anlehnung an Curriculum und Bildungsstandards)",
		...
		{
			title: "Interessegeleitete Themenführung/Positionierung (Dimension 2: Diskursive Positionierung)",
		...
		{
			title: "Transparenz (Dimension 2: Diskursive Positionierung)",
		...
		{
			title: "Werbliche Elemente (Dimension 2: Diskursive Positionierung)",
		...
		{
			title: "Heterogenität/Gender (Dimension 2: Diskursive Positionierung)",
		...
		{
			title: "Handlungsorientierung (Dimension 3: Makrodidaktische und bildungstheoretische Fundierung)",
		...
		{
			title: "Lebensweltlichkeit (Dimension 3: Makrodidaktische und bildungstheoretische Fundierung)",
		...
		{
			title: "Reflexion/Urteilsfähigkeit (Dimension 3: Makrodidaktische und bildungstheoretische Fundierung)",
		...
		{
			title: "Multiperspektivität/Kontroversität (Dimension 3: Makrodidaktische und bildungstheoretische Fundierung)",
		...
		{
			title: "Methodenpluralität (Dimension 4: Mikrodidaktische Umsetzung)",
		...
		{
			title: "Multimedia/Multimodalität (Dimension 4: Mikrodidaktische Umsetzung)",
		...
		{
			title: "Medienkompetenz (Dimension 4: Mikrodidaktische Umsetzung)",
		...
		{
			title: "Differenzierung (Dimension 4: Mikrodidaktische Umsetzung)",
		...
		{
			title: "Barrierefreiheit/Inklusion (Dimension 4: Mikrodidaktische Umsetzung)",
		...
		{
			title: "Transfer- und Anwendungsorientierung (Dimension 5: Kognitive Strukturierung)",
		...
		{
			title: "Prozessorientierung (Kumulation) (Dimension 5: Kognitive Strukturierung)",
		...
		{
			title: "Lernwegunterstüzende Elemente (Scaffolding) (Dimension 5: Kognitive Strukturierung)",
		...
		{
			title: "Sprachlichkeit (Dimension 6: Bild- und Textkomposition)",
		...
		{
			title: "Bildsprache (Dimension 6: Bild- und Textkomposition)",
		...
		{
			title: "Additive Kommunikation (Anreicherung) (Dimension 6: Bild- und Textkomposition)",
		...
		{
			title: "Sequenzierung (Dimension 7: Aufgabendesign)",
		...
		{
			title: "Aktivierung (Dimension 7: Aufgabendesign)",
		...
		{
			title: "Multiple Lösungswege (Dimension 7: Aufgabendesign)",
		...
		{
			title: "Didaktisches Konzept (Dimension 8: Anwendungstransparenz)",
		...
		{
			title: "Rahmenbedingungen (Dimension 8: Anwendungstransparenz)",
...
let surveyTextEn = [
	...
	{
        title: "References to the Curriculum (Dimension 1: References to Curriculum and Educational Standards)",
	...
	{
        title: "References to Educational Standards  (Dimension 1: References to Curriculum and Educational Standards)",
    ...
    {
        title: "Interest-driven Mediation of Topics/Positioning (Dimension 2: Discoursive Positioning)",
	...
	{
        title: "Transparency (Provider/Authors/Motivation) (Dimension 2: Discoursive Positioning)",
    ...
    {
        title: "Promotional Elements (Dimension 2: Discoursive Positioning)",
    ...
    {
        title: "Heterogeneity/Gender (Dimension 2: Discoursive Positioning)",
    ...
    {
        title: "Action-orientation (Dimension 3: Macro-Didactical Foundation / Foundation in Educational Theory)",
    ...
    {
        title: "Reference to the Learners’ Social and Cultural Background (Dimension 3: Macro-Didactical Foundation / Foundation in Educational Theory)",
    ...
    {
        title: "Reflection/Ability to Judge (Dimension 3: Macro-Didactical Foundation / Foundation in Educational Theory)",
    ...
    {
        title: "Multiperspectivity/Controversy (Dimension 3: Macro-Didactical Foundation / Foundation in Educational Theory)",
    ...
    {
        title: "Plurality in Methods of Learning and Teaching (Dimension 4: Microdidactical Implementation)",
    ...
    {
        title: "Multimedia/Multimodality (Dimension 4: Microdidactical Implementation)",
	...
	{
        title: "Media Literacy (Dimension 4: Microdidactical Implementation)",
    ...
    {
        title: "(Internal) Differentiation (Dimension 4: Microdidactical Implementation)",
	...
	{
        title: "Acessibility / Inclusion (Dimension 4: Microdidactical Implementation)",
    ...
    {
        title: "Transfer  and Application Orientation (Dimension 5: Cognitive Structuring)",
    ...
    {
        title: "Process Orientation (Accumulation) (Dimension 5: Cognitive Structuring)",
    ...
    {
        title: "Elements Supporting the Learning Process (Scaffolding) (Dimension 5: Cognitive Structuring)",
    ...
    {
        title: " Language (Dimension 6: Composition of Visual and Textual Content)",
	...
	{
        title: "Visual Literacy (Dimension 6: Composition of Visual and Textual Content)",
    ...
    {
        title: "Additive Communication (Enrichment) (Dimension 6: Composition of Visual and Textual Content)",
    ...
    {
        title: "Sequencing (Dimension 7: Design of Assignments)",
    ...
    {
        title: "Activation (Dimension 7: Design of Assignments)",
    ...
    {
        title: "Multiple Approaches (Dimension 7: Design of Assignments)",
    ...
    {
        title: "Didactical Concept (Dimension 8: Instructional Applicability and Transparency of Application)",
    ...
    {
        title: "Framework Conditions (Dimension 8: Instructional Applicability and Transparency of Application)",
		...
		indicators:" Indikatoren für eine positive Bewertung dieses Items: Indicators of a positive rating for this item: All preconditions for use of the educational medium are concisely specified."
    },
	{
        title: "Own Notes",
        description: "...",
...
let surveyTextHistoryDe = [
	...
	{
		name: "Kongruenz mit den fachspezifischen Zielen des Lehrplans (Dimension I: Anlehnung an Curriculum und fachspezifische Bildungsstandards)",
		...
		indicators:" Indikatoren für eine positive Bewertung dieses Items: Das Lehr-Lernmittel macht den Lehrkräften transparent, dass es auf die Entwicklung eines reflektierten Geschichtsbewusstseins bei den Schüler*innen  zielt. Idealerweise nimmt das Lehr-Lernmittel selbst (z. B. in einem didaktischen Kommentar) diese Zuordnung vor und erläutert diese in Bezug auf einzelne oder mehrere Dimensionen des Geschichtsbewusstseins und auf einzelne oder mehrere angestrebte Bewusstseinsprozesse. Dies kann auch so geschehen, dass direkte oder indirekte Bezüge zu den Erläuterungen im konkreten Lehrplan hergestellt werden."
	},
	{
		name: "Kongruenz mit den fachspezifischen Kompetenzen des Lehrplans (Dimension I: Anlehnung an Curriculum und fachspezifische Bildungsstandards)",
	...
	},
	{
		...
		indicators:" Indikatoren für eine positive Bewertung dieses Items: Das Lehr-Lernmittel macht den Lehrkräften transparent, dass es sich auf ein im Lehrplan aufgeführtes historisches Inhaltsfeld bezieht und das Themenfeld entsprechend der Lehrplanvorgaben umsetzt. Das Lehr-Lernmittel entspricht den für einzelne Themen vorgesehene inhaltliche Strukturierungskonzepten. Idealerweise nimmt das Lehr-Lernmittel selbst (z. B. in einem didaktischen Kommentar) diese Zuordnungen vor. Dies kann auch so geschehen, dass direkte Bezüge zu den Erläuterungen im konkreten Lehrplan hergestellt werden."
	},
	{
		name: "Trennung von historischer (Sach-)information und Deutung/Wertung (Dimension II: Diskursive Positionierung)",
	...
	
	{
		...
		indicators:" Indikatoren für eine positive Bewertung dieses Items: Die Autor*innen haben das Lehr-Lernmittel so angelegt, dass es gegenwärtige, diskriminierende, rassistische und antisemitische Stereotype in Bezug auf verschiedene gesellschaftliche Gruppierungen nicht fortschreibt, sondern in ihrer historischen Bedingtheit hinterfragt. An die Stelle von eurozentrischen Geschichtsbilder treten plurale Geschichtsbilder, welchen von Respekt gegenüber anderen Weltregionen und ihrer historischen Entwicklung geprägt sind. Unabhängig vom Thema kommen auch vermeintlich historisch Schweigende zur Sprache.  "
	},
	{
		name: "Wissenschaftsorientierung (Dimension III: Makrodidaktische bzw. bildungstheoretische Fundierung)",
	...
	{
		name: "Kontroversität (Dimension III: Makrodidaktische bzw. bildungstheoretische Fundierung)",
	...
	},
	{
		...
		indicators:" Indikatoren für eine positive Bewertung dieses Items: Das Lehr-Lehrmittel hilft, die Schüler*innen sich ihrer eigenen Wahrnehmungen und Deutungen von Vergangenheit und deren Ursachen bewusst zu machen und in der Diskussion im Klassenverband zu verteidigen. Die Medien, Aufgabenstellungen und Methoden sind entsprechend der Vorkenntnisse der Schüler*innen darauf ausgelegt, die historisch Lernenden dabei zu unterstützen, ihre Wahrnehmungen und Deutungen als solche zu verstehen, sie zu überdenken und die Argumente anderer nachzuvollziehen und anzunehmen bzw. zu akzeptieren. "
	},
	{
		name: "Gegenwarts-/Zukunftsorientierung (Dimension III: Makrodidaktische bzw. bildungstheoretische Fundierung)",
	...
	},
	{
		...
		indicators:" Indikatoren für eine positive Bewertung dieses Items: Das Lehr-Lernmittel enthält historischen Quellen und/oder Darstellungen und unterscheidet für die Schüler*innen zwischen diesen beiden Präsentationsformen (von Geschichte). Die Bedeutung beider für die Konstruktion von Geschichte wird für die Schüler*innen nachvollziehbar im Lehr-Lernmittel angesprochen und erklärt. Das Lehr-Lernmittel stellt eine Beziehung zwischen der Frage, welche an das einzelne Material gestellt wird, und seiner Typisierungen als Quelle oder Darstellung her (z. B. durch Vorworte, Erläuterungen etc.)."
	},
	{
		name: "Charakter der historischen Quellen (Dimension IV: Mikrodidaktische Umsetzung)",
	...
	{
		name: "Methode der (Re-)Konstruktion von Geschichte (Quellenarbeit) (Dimension IV: Mikrodidaktische Umsetzung)",
	...
	},
	{
		...
		indicators:" Indikatoren für eine positive Bewertung dieses Items: Das Lehr-Lehrmittel vermittelt, übt, vertieft oder verfeinert einzelne oder mehrere Prozesse historischen Denkens, sodass sie auf andere Kontexte übertragen werden können. Fachspezifische Methoden und Arbeitstechniken, Erkenntnisverfahren und Deutungsmuster historischen Denkens werden so erworben, dass sie auf andere Themenfelder, andere historischen Quellen, andere Darstellung, andere Fächer, aber v.a. auf den außer- und nachschulischen Bereich übertragen und angewandt werden können. Im Idealfall stellt das Lehr-Lehrmittel den Schüler*innen transparent dar, welche weiteren Anwendungsbezüge das soeben erlernte hat. Gerade der außer- und nachschulische Zusammenhang sollte den Schüler*innen nachvollziehbar im Lehr-Lernmittel angelegt sein."
	},
	{
		name: "Narrative Struktur und Sprache (Dimension VI: Bild- und Textkomposition)",
		...
		indicators:" Indikatoren für eine positive Bewertung dieses Items: Die im Lehr-Lernmittel enthaltenen Lehrtexte sind narrativ verfasst. Die Erzählung zeichnet sich inhaltlich und sprachlich durch ein für die Schüler*innen nachvollziehbares Ursache-Wirkungs-Geflecht aus. „Generalisierungen von Generalisierungen“ sowie „blumige, rhetorische Redewendungen“ (Pandel) wurden vermieden. Stattdessen geht es um eine möglichst konkrete, aktivistische Darstellung mit assoziationsreichen Begriffen ohne Leeformeln und suggestiver Bildsprache, welche sich an bereits vorhandene Erzählungen anschließt und den Schüler*innen eine, authentische Vorstellungen von den historischen Begebenheiten, Umständen und Zusammenhängen erlaubt. "
	},
	{
		name: "Fachvokabular und Begriffe (Dimension VI: Bild- und Textkomposition)",
	...
	{
		name: "Fachspezifische Paratexte/Hilfsdiskurse (Dimension VI: Bild- und Textkomposition)",
		...
		indicators:" Indikatoren für eine positive Bewertung dieses Items: Das Lehr-Lernmittel enthält zusätzliche Elemente in Form von Texten, Bildern und Sprache, welche die Schüler*innen ansprechen. Sie ergänzen, erklären und verstärken die im Lehr-Lernmittel vermittelten historischen Inhalte, Methoden und Denkweisen. Gängige Formen sind z. B. Vorworten, Zeitleisten, Info-  und Lexikonboxen und Glossare. Sie liefern auch angemessene Hintergrundinformationen, welche für die Analyse und Interpretation der im Lehr-Lernmittel präsentierten historischen Quellen und Darstellungen unabdingbar sind."
	},
	{
		name: "Aktivierende gegenwartsrelevante, historische Leitfragen als Lernimpuls (Dimension VII: Aufgabendesign)",
	...
	{
		name: "Rahmenbedingungen (Dimension VIII: Anwendungstransparenz)",
...
let surveyTextHistoryEn = [
	...
	{
		name: "Congruence with the subject-specific goals according to the curriculum (Dimension I: References to subject-specific curriculum and standards)",
		...
		indicators:" Indicators of a positive rating for this item: This educational resource makes transparent to the teachers that it aims at developing a reflected awareness of history among the students. In the ideal case, the educational resource makes this attribution itself (e. g. by way of a didactic comment) and explains it by referring to individual or several dimensions of historical awareness as well as to individual or several desired awareness processes. This may as well happen by directly or indirectly referring to the explanations of the concrete curriculum."
	},
	  
	{
		name: "Congruence with the subject-specific competencies according to the curriculum (Dimension I: References to subject-specific curriculum and standards)",
		...
		indicators:" Indicators of a positive rating for this item: This educational resource makes transparent to the teachers that it is oriented at the support of one or several (sub-)competencies of historical thinking at a certain level of education. In the ideal case, the educational resource itself (e. g. by way of a didactic comment) makes this attribution and explains it concerning one of several historical skills and sub-skills. This may as well happen by way of establishing immediate reference to the explanations given by the concrete curriculum."
	},
	
	{
		name: "Congruence with the subject-specific topical fields according to the curriculum (Dimension I: References to subject-specific curriculum and standards)",
		...
		indicators:" Indicators of a positive rating for this item: This educational resource makes transparent to the teachers that it is oriented to one or more historical topics mentioned in the curriculum. The educational resource corresponds to the contract structuring concepts provided for individual topics according to the curriculum. In the ideal case, the educational resources itself (e. g. by way of a didactic comment) makes these attributions directly. This can also be done by the way of establishing immediate reference to the explanations given by the concrete curriculum."
	},
	{ 
		name: "Distinguishing historical (topical) information from interpretation/personal judgement (Dimension II: Discursive Positioning)", 
	...
	{ 
		...
		indicators:" Indicators of a positive rating for this item: The authors have designed this educational resource in such a way as to not continuing current discriminating, racist, and anti-Semitic stereotypes concerning different groups of society, but it discusses their historical relativity. Instead of Euro-centric conceptions of history there are pluralist conceptions which are characterised by showing respect to other regions of the world and their historical developments. Independently of the topic, also those are presented who are allegedly silent in history."
	},
	{ 
		name: "Orientation at science (Dimension III: Macro-Didactic foundation / Foundation in Educational Theory)", 
		...
		indicators:" Indicators of a positive rating for this item: Topically, this educational resource represents positions which are in line with the consensus of the current subject-specific scientific research. By referring to current subject-related scientific literature (e. g. quotations, footnotes, lists of references etc.) this is communicated to the students. In this context, subject-specific literature on the topic must be preferred over brief, much condensed overall depictions. As concerns their overall concept, these educational resources are made in such a way as to make obvious on what the historical research agrees, however also what is disputed and discussed. Also 'minority positions'shall be represented by the educational resource."
	},
	{ 
		name: "Orientation at sources/methods (Dimension III: Macro-Didactic foundation / Foundation in Educational Theory)",
	...
	{ 
		...
		indicators:" Indicators of a positive rating for this item: This educational resource includes two or more sources of involved or concerned contemporaries, representing different 'views'at the historical event or situation. According to the knowledge acquired by the students thus far, the media, exercises and methods are made for investigating the causes of the different points of view and for comparing them. Positions of certain actors or concerned persons which have not been handed down are not excluded, however they are also not faked as 'quasi-sources'but are discussed."
	},
	{ 
		name: "Controversity (Dimension III: Macro-Didactic foundation / Foundation in Educational Theory)",
	...
	},
	{
		...
		indicators:" Indicators of a positive rating for this item: This educational resource is oriented at the foundations of the Historical method, and, according to the already acquired knowledge of the students, it communicates, practices, consolidates or refines individual or several steps of the method of the (re)construction of history on the basis of several genres of historical sources. Also, references are made (e. g. by hints connected to the exercises of methodical instructions) to other (sub-)steps of source work which are not explicitly worked out with the students in the context of this educational resources. Heuristics as well as (inner) criticism are as little ignored as the sub-steps of establishing a narration themselves."
	},
	{
		name: "The method of the deconstruction of representations (Dimension IV: Microdidactical Implementation)",
		...
		indicators:" Indicators of a positive rating for this item: This educational resource is oriented at the foundations of the historical method and communicates, practices, consolidates or refines, in ways which are appropriate to the previously acquired knowledge of the students, individual or several steps of the method of the deconstruction of existing historical representations or those presented by the educational resources itself. In genre-specific ways (e. g. by hints in the context of exercises or methodical instruction), also references to other aspects of the method of deconstruction are made which cannot be explicitly worked out with the students in the context of this educational resource."
	},
	{
		name: "The method of historical comparison (Dimension IV: Microdidactical Implementation)",
	...
	},
	{
		...
		indicators:" Indicators of a positive rating for this item: This educational resource fits in to the process of the step-by-step building of dimensions of historical knowledge. More voluminous educational resources guide this process themselves, by proceeding step by step and by meaningfully connecting each individual sequence and phase when it comes to the different dimensions of knowledge which are supposed to be addressed. Less voluminous educational resources, which address just one or a few dimensions of knowledge, make transparent which processes must have been made by the students already outside. Then this educational resource connects to this in cumulative ways."
	},
	{
		name: "The transfer/application of historical competencies (Dimension V. Cognitive Structuring)",
	...
	},
	{
		...
		indicators:" Indicators of a positive rating for this item: Subject-specific terms and words of foreign origin are adjusted, used and, if necessary, explained to an extent which is necessary and reasonable for the subject and in line with the students'learning progress. The historical and cultural conditionality of certain terms is not ignored. One-sided, historically derogatory terms for certain groups of people which might give support to stereotypes as well as Euro-centric, subjective geo-political attributions are avoided or are made subject to active discussion in the classroom."
	},
	{
		name: "Subject-specific function of images (Dimension VI: Composition of Visual and Textual Content)",
	...
	
	{
		...
		indicators:" Indicators of a positive rating for this item: The individual tasks can be attributed to the fields of factual analysis, factual judgement and value judgement. The exercises are appropriately oriented and are comprehensible for the students. Precisely in the lower classes this setting is more instructive for the students, the exercises are more small-scale, the individual exercises focus on individual aspects and steps of historical thinking. The share of problems which really network all fields of historical thinking skills (most of all the level of 'reflection') increases with each grade. Then the tasks are more all-encompassing, individual aspects and steps must be solved more independently by the students."
	},
	
	{
		name: "26. The material-methodical focus of the historical setting of tasks (Dimension VII: Task Design)",
		...
		indicators:" Indicators of a positive rating for this item: This setting of tasks focuses on the subject-specific teaching-learning media (historical sources, representations) as well as on subject-specific epistemic methods (construction, deconstruction, historical comparison). The design of the tasks serves as a genre-specific guideline for the students when it comes to learning, exercising, applying, consolidating and extending these subject-specific methods and offers appropriate aids for understanding."
	},
	
	{
		name: "27. Didactical concept (Dimension VIII: Instructional Applicability and Transparency of Application)",
	...
	
	{
		...
		indicators:" Indicators of a positive rating for this item: All necessary general conditions of the use/application of this educational resource are clearly named."
	},
	{
