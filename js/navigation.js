...
let surveyTextHistoryDe = [
	...
	{
		name: "I. Kongruenz mit den fachspezifischen Zielen des Lehrplans (Dimension: Anlehnung an Curriculum und fachspezifische Bildungsstandards)",
	...
	{
		name: "II. Kongruenz mit den fachspezifischen Kompetenzen des Lehrplans (Dimension: Anlehnung an Curriculum und fachspezifische Bildungsstandards)",
	...
	{
		name: "III. Kongruenz mit den fachspezifischen Inhaltsfeldern des Lehrplans (Dimension: Anlehnung an Curriculum und fachspezifische Bildungsstandards)",
	...
	{
		name: "IV. Trennung von historischer (Sach-)information und Deutung/Wertung (Dimension: Diskursive Positionierung)",
	...
	{
		name: "VI. Wissenschaftsorientierung (Dimension: Makrodidaktische bzw. bildungstheoretische Fundierung)",
	...
	{
		name: "VII. Quellen-/Methodenorientierung (Dimension: Makrodidaktische bzw. bildungstheoretische Fundierung)",
	...
	{
		name: "VIII. Multiperspektivität i. e. S. (Dimension: Makrodidaktische bzw. bildungstheoretische Fundierung)",
	...
	{
		name: "X. Pluralität (Dimension: Makrodidaktische bzw. bildungstheoretische Fundierung)",
	...
	{
		name: "XI. Gegenwarts-/Zukunftsorientierung (Dimension: Makrodidaktische bzw. bildungstheoretische Fundierung)",
	...
	{
		name: "XII. Unterscheidungen von historischen Quellen und Darstellungen (Dimension: Mikrodidaktische Umsetzung)",
	...
	{
		name: "XIII. Charakter der historischen Quellen (Dimension: Mikrodidaktische Umsetzung)",
	...
	{
		name: "XVIII. Kumulation von historischen Wissensdimensionen (Dimension: Kognitive Strukturierung)",
	...
	{
		name: "XIX. Progression und Transfer/Anwendung von historischen Kompetenzen (Dimension: Kognitive Strukturierung)",
		description: "„Gute“ Geschichtslehrmittel müssen fachspezifisch kompetenzorientiert sein und diese fachspezifisch, in den Lehrplänen dargelegten historischen Kompetenzen entsprechend des aktuellen Kompetenzstandes der Schüler*innen einüben, weiterentwickeln, vertiefen, anzuwenden, verfeinern und miteinander vernetzen. Die Kompetenzen sollen dabei zunächst über die Aufgabenstellungen auf einem basalen Niveau, dann auf einem intermediären Niveau und schließlich auf einem elaborierten Niveau angesprochen werden. Dabei ist auch die Frage zu stellen, ob das Lehr-Lernmittel so konzipiert ist, dass an ihm beispielhaft fachspezifische Methoden und Arbeitstechniken, Erkenntnisverfahren und Deutungsmuster historischen Denken kennen zu lernen sind, die dann auch auf andere – auch schwierigere – historische Themenfelder, historische Quellen bzw. Darstellungen sowie andere Schulfächer und v. a. außerschulisch und damit gegenwarts- und zukunftsrelevant angewandt werden können.",
		...
		indicators: "Indikatoren für eine positive Bewertung dieses Items: Das Lehr-Lehrmittel vermittelt, übt, vertieft oder verfeinert einzelne oder mehrere Prozesse historischen Denkens, sodass sie auf andere Kontexte übertragen werden können. Fachspezifische Methoden und Arbeitstechniken, Erkenntnisverfahren und Deutungsmuster historischen Denkens werden so erworben, dass sie auf andere Themenfelder, andere historische Quellen, andere Darstellung, andere Fächer, aber v.a. auf den außer- und nachschulischen Bereich übertragen und angewandt werden können. Im Idealfall stellt das Lehr-Lehrmittel den Schüler*innen transparent dar, welche weiteren Anwendungsbezüge das soeben erlernte hat. Gerade der außer- und nachschulische Zusammenhang sollte den Schüler*innen nachvollziehbar im Lehr-Lernmittel angelegt sein."
	},	
	{
		name: "XX. Narrative Struktur und Sprache (Dimension: Bild- und Textkomposition)",
	...
	{
		name: "XXII. Fachspezifische Bildfunktion (Dimension: Bild- und Textkomposition)",
	...
	{
		name: "XXIII. Fachspezifische Paratexte/Hilfsdiskurse (Dimension: Bild- und Textkomposition)",
	...
	{
		name: "XXIV. Aktivierende gegenwartsrelevante, historische Leitfragen als Lernimpuls (Dimension: Aufgabendesign)",
		...
		summary: "Das Aufgabensetting des Lehr-Lernmittels geht einer gegenwartsrelevanten, historischen Leitfrage als Lernimpuls nach.",
	...
	{
		name: "XXV. Sequenzierung und Angemessenheit des historischen Aufgabensettings (Dimension: Aufgabendesign)",
	...
	{
		name: "XXVII. Didaktisches Konzept (Dimension: Anwendungstransparenz)",
	...
	{
		name: "XXVIII. Rahmenbedingungen (Dimension: Anwendungstransparenz)",
...
let surveyTextHistoryEn = [
	...
	{
		name: "I. Congruence with the subject-specific goals according to the curriculum (Dimension: References to subject-specific curriculum and standards)",
	...
	{	  
		name: "II. Congruence with the subject-specific competencies according to the curriculum (Dimension: References to subject-specific curriculum and standards)",
	...
	{
		name: "III. Congruence with the subject-specific topical fields according to the curriculum (Dimension: References to subject-specific curriculum and standards)",
	...
	{
		name: "IV. Distinguishing historical (topical) information from interpretation/personal judgement (Dimension: Discursive Positioning)",
	...
	{
		name: "V. Conceptions of history: Non-discriminating and in conformity with the constitution (Dimension: Discursive Positioning)",
	...
	{
		name: "VI. Orientation at science (Dimension: Macro-Didactic foundation / Foundation in Educational Theory)",
	...
	{
		name: "VII. Orientation at sources/methods (Dimension: Macro-Didactic foundation / Foundation in Educational Theory)",
	...
	{
		name: "VIII. Multiperspectivity (Dimension: Macro-Didactic foundation / Foundation in Educational Theory)",
	...
	{
		name: "IX. Controversity (Dimension: Macro-Didactic foundation / Foundation in Educational Theory)",
	...
	{
		name: "X. Plurality (Dimension: Macro-Didactic foundation / Foundation in Educational Theory)",
	...
	{
		name: "XI. Orientation at the present/future (Dimension: Macro-Didactic foundation / Foundation in Educational Theory)",
	...
	{
		name: "XII. Distinguishing historical sources and representations (Dimension: Microdidactical Implementation)",
	...
	{
		name: "XIII. The nature of the used historical sources (Dimension: Microdidactical Implementation)",
	...
	{
		name: "XIV. The nature of the used representations (Dimension: Microdidactical Implementation)",
	...
	{
		name: "XV. The method of the (re)construction of history (source work) (Dimension: Microdidactical Implementation)",
	...
	{
		name: "XVI. The method of the deconstruction of representations (Dimension: Microdidactical Implementation)",
	...
	{
		name: "XVII. The method of historical comparison (Dimension: Microdidactical Implementation)",
	...
	{
		name: "XVIII. Accumulation of dimensions of historical knowledge (Dimension: Cognitive Structuring)", 
	...
	{
		name: "XIX. The transfer/application of historical competencies (Dimension: Cognitive Structuring)",
	...
	{
		name: "XX. Narrative structure and language (Dimension: Composition of Visual and Textual Content)",
	...
	{
		name: "XXI. Subject-related vocabulary and terms (Dimension: Composition of Visual and Textual Content)",
	...
	{
		name: "XXII. Subject-specific function of images (Dimension: Composition of Visual and Textual Content)",
	...
	{
		name: "XXIII. Subject-specific paratexts/support discourses (Dimension: Composition of Visual and Textual Content)",
	...
	{
		name: "XXIV. Activating, historical guiding questions with present-time relevance (Dimension: Task Design)",
	...
	{
		name: "XXV. Sequencing the historical setting of tasks (Dimension: Task Design)",
	...
	{
		name: "XXVI. The material-methodical focus of the historical setting of tasks (Dimension: Task Design)",
	...
	{
		name: "XXVII. Didactical concept (Dimension: Instructional Applicability and Transparency of Application)",
	...
	{
		name: "XXVIII. General conditions (Dimension: Instructional Applicability and Transparency of Application)",
