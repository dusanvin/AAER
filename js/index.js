...
function display_dashboard() {
    var container = document.getElementById("dashboard-aaer");
    container.innerHTML = `
					    ...
					    <div id="sidebar-wrapper" style="background-color: #2F3436">
							...
							<div class="list-group list-group-flush">
								...
								<button id="button_display_overallChart" class="list-group-item list-group-item-action">
									...
									<svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-pie-chart-fill list-group-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
								...
								<button id="button_display_grp1Chart" class="list-group-item list-group-item-action">
									...
									<svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-book-half list-group-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
								...
								<button id="button_display_grp2Chart" class="list-group-item list-group-item-action">
									...
									<svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-signpost list-group-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
								...
								<button id="button_display_grp3Chart" class="list-group-item list-group-item-action">
									...
									<svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-aspect-ratio-fill list-group-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
								...
								<button id="button_display_grp4Chart" class="list-group-item list-group-item-action">
									...
									<svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-aspect-ratio list-group-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
								...
								<button id="button_display_grp5Chart" class="list-group-item list-group-item-action">
									...
									<svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-card-checklist list-group-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
								...
								<svg width="1.3em" height="1.2em" viewBox="0 0 17 16" class="bi bi-image-fill list-group-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
								...
								<button id="button_display_grp7Chart" class="list-group-item list-group-item-action">
									...
									<svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-check-square-fill list-group-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
								...
								<button id="button_display_grp8Chart" class="list-group-item list-group-item-action mb-3">
									...
									<svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-eye-fill list-group-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
								...
								<button id="button_display_PDF" class="list-group-item list-group-item-action">

									<svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-arrow-down-square-fill list-group-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
								...
								<button id="button_display_JSON" class="list-group-item list-group-item-action">
									...
									<svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-code-square list-group-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
					    ...
					    <div id="page-content-wrapper">
							...
							<nav class="navbar navbar-expand-lg navbar-dashboard">
								...
								<button class="btn btn-primary btn-toggle" id="menu-toggle">
									...
									<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-layout-sidebar-inset mr-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="margin-bottom:-2px">
							...
							<div class="p-md-5 p-lg-5 m-md-3 m-lg-5 mt-5 text-center" id="display_thanks">
								...
								<p class="font-weight-normal lead-text pt-xs-1 pt-sm-1 pt-md-5 pt-lg-5 m-xs-1 m-sm-3 px-xs-1 px-sm-1 px-md-3 px-lg-3">Ihre Daten in <strong>visualisierter Form</strong></p>
								<p class="resultate_info lead-text px-xs-1 px-sm-1 px-md-3 px-lg-3">Wir hoffen, Ihre Bewertungen helfen Ihnen bei der <strong>Verwendung des Bildungsmediums</strong> in Anlehnung an dessen Qualität für Unterricht und Schule.</p>
							      ...
							      <div class="row justify-content-center">
							        ...
							        <div class="col">
							          ...
							          <div id="uebersicht">
													...
													<div class="col">
														...
														<div class="container-fluid mb-3">
															...
															<div class="row pt-1 pb-1 lehr-lernmittel-heading">
																...
																<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-5 pl-0 pr-0">

																	<p class="lehr-lernmittel-heading mb-2 mt-3 pl-3">Verlinkung</p>

																	<div style="background-color: #f1f3fa; border-bottom-left-radius: 7px; border-top-left-radius: 7px; min-height:76px;" class="pt-3 pb-3 pl-3 pr-3"> 

																		<a id="link_lernmittel" style="word-break:break-word; font-weight:400; font-size:80%;" target="_blank" rel="noopener" alt="Verlinkung zum Lehr- und Lernmittel"></a>

																	</div>

																</div>

																<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-3 pl-0 pr-0">

																	<p class="lehr-lernmittel-heading mb-2 mt-3 pl-3">Schulart</p>

																	<div style="background-color: #f1f3fa; min-height:76px;" class="pt-3 pb-3 pl-3 pr-3"> 

																		<a id="schulart" style="word-break:break-word; font-weight:400; font-size:80%;"></a>

																	</div>

																</div>

																<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-2 mt-3 pl-0 pr-0">

																	<p class="mb-2 pl-3 lehr-lernmittel-heading">Fach</p>

																	<div style="background-color: #f1f3fa; min-height:76px;" class="pt-3 pb-3 pl-3"> 

																		<a id="fach" style="word-break:break-word; font-weight:400; font-size:80%;"></a>
																...
																<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-2 mt-3 pl-0 pr-0">
																	...
																	<p class="mb-2 pl-3 lehr-lernmittel-heading">Datum</p>

																	<div style="background-color: #f1f3fa; border-bottom-right-radius: 7px; border-top-right-radius: 7px; min-height:76px;" class="pt-3 pb-3 pl-3 pr-3"> 

																		<a id="datum_lernmittel" style="word-break:break-word; font-weight:400; font-size:80%;"></a>

																	</div>
																
																</div>

																<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-3 pl-0 pr-0">

																	<p class="mb-2 pl-3 lehr-lernmittel-heading">Anmerkungen</p>

																	<div style="background-color: #f1f3fa; border-radius: 7px; min-height:76px;" class="pt-3 pb-3 pl-3 pr-3"> 

																		<a id="anmerkungen" style="word-break:break-word; font-weight:400; font-size:80%;"></a>
											...
											<div class="container-fluid grey-border mt-3">
												...
												<div class="row pt-4 bg-white">
													...
													<div class="col text-right" style="max-width:fit-content;">
														...
														<svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-info-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="color:#009688;">
													...
													<div class="col pl-0">
														...
														<p style="font-size:80% !important;">
															Ihre Bewertungen werden in dieser Darstellung in absteigender Reihenfolge - <strong>der Wertigkeit nach</strong> - visualisiert. Während <em>0</em> für <em>nicht bewertbar</em> steht, repräsentieren <em>1 = trifft nicht zu</em>, <em>2 = trifft weniger zu</em>, <em>3 = trifft mehr zu</em> und <em>4 = trifft voll zu</em>. Diese Indexierung gilt für alle Auswertungen.
							            ...
							            <div class="d-flex justify-content-center mt-3 mb-3 p-3 bg-white grey-border" style="height:1200px !important;">
							              
							            <canvas id="overallChart" style="max-width: 1450px; height: 1200px !important;"></canvas>
							...
							<!-- Beginn Container grp1Chart -->

						    <div class="container-fluid mt-5 px-xl-5 px-lg-5 px-md-3 px-sm-3 px-xs-1" id="display_grp1Chart">

						    <h2 class="font-weight-normal lead-text mb-0"><strong>Curriculum & Bildungsstandards</strong></h2>
						      ...
						      <div class="row justify-content-center mt-4">
						        ...
						        <div class="col mb-3 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
						          ...
						          <!-- Canvas grp1Chart Start -->

						          <div id="grp1Chartuebersicht" class="grey-border">

						            <div class="d-flex justify-content-center p-3 bg-white">

						            <canvas id="grp1Chart" style="max-width: 480px; max-height: 340;"></canvas>

						            </div>

						          </div>

						          <!-- Canvas grp1Chart Ende -->
						        ...
						        <div class="col d-flex">
									...
									<p class="resultate_info">Die Items <strong>Curriculum</strong> und <strong>Bildungsstandards</strong> beziehen sich auf eine transparente Ausrichtung des Lehr- und Lernmittels an gültigen Curricula sowie geltenden Bildungsstandards. Dies betrifft beispielsweise die fach-, stufen- und jahrgangsbezogenen Ziele, angepasst an den Kompetenz- sowie Anforderungsbereichen deutscher Bildungsstandards.</p>
						    ...
						    <!-- Ende Container grp1Chart -->



							<!-- Beginn Container grp2Chart -->

							<div class="container-fluid mt-5 px-xl-5 px-lg-5 px-md-3 px-sm-3 px-xs-1" id="display_grp2Chart">

								<h2 class="font-weight-normal lead-text mb-0"><strong>Diskursive Positionierung</strong></h2>
								...
								<div class="row justify-content-center mt-4">
									...
									<div class="mb-3 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">

										<!-- Canvas grp2Chart Start -->

										<div id="grp1Chartuebersicht" class="grey-border">

										    <div class="d-flex justify-content-center p-3 bg-white">

										    	<canvas id="grp2Chart" style="max-width: 480px; max-height: 340;"></canvas>

										    </div>

										</div>

										<!-- Canvas grp2Chart Ende -->
									...
									<div class="col d-flex">
										...
										<p class="resultate_info">Die Items <strong>Interessensgeleitete Themenführung / Positionierung, Transparenz, Werbliche Elemente</strong> und <strong>Heterogenität / Gender</strong> widmen sich der <em>diskursiven Positionierung</em> des Lehr- und Lernmittels. Dies umfasst etwa die Objektivität der Ressource, die multiperspektive Aufarbeitung der behandelten Thematik, Transparenz bezüglich der Motive der verfassenden Person sowie das Vorhandensein von werblichen Elementen. Zudem fokussiert das Item <strong>Heterogenität / Gender</strong> mögliche Zuschreibungen auf soziale oder gesellschaftliche Umwelten und das Maß an kultureller Diversität.</p>
							...
							<!-- Ende Container grp2Chart -->



							<!-- Beginn Container grp3Chart -->

							<div class="container-fluid mt-5 px-xl-5 px-lg-5 px-md-3 px-sm-3 px-xs-1" id="display_grp3Chart">

								<h2 class="font-weight-normal lead-text mb-0"><strong>Makrodidaktische Fundierung</strong></h2>
								...
								<div class="row justify-content-center mt-4">
									...
									<div class="mb-3 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
										...
										<!-- Canvas grp3Chart Start -->

										<div id="grp1Chartuebersicht" class="grey-border">

										    <div class="d-flex justify-content-center p-3 bg-white">

										    	<canvas id="grp3Chart" style="max-width: 480px; max-height: 340;"></canvas>

										    </div>

										</div>

										<!-- Canvas grp3Chart Ende -->
									...
									<div class="col d-flex">
										...
										<p class="resultate_info">Die Items <strong>Handlungsorientierung, Lebensweltlichkeit, Reflexion / Urteilsfähigkeit</strong> und <strong>Multiperspektivität / Kontroversität</strong> bilden den Bereich der <em>makrodidaktischen Fundierung</em>. Im Fokus stehen somit die Fragen, ob aktiv Wissensstrukturen erschlossen, ein Lebensweltbezug hergestellt, Prozesse der Selbstrefelexion gefördert sowie aktuelle Themen sowohl multiperspektivistisch als auch kontrovers diskutiert werden.</p>
							...
							<!-- Ende Container grp3Chart -->



							<!-- Beginn Container grp4Chart -->

							<div class="container-fluid mt-5 px-xl-5 px-lg-5 px-md-3 px-sm-3 px-xs-1" id="display_grp4Chart">

								<h2 class="font-weight-normal lead-text mb-0"><strong>Mikrodidaktische Fundierung</strong></h2>
								...
								<div class="row justify-content-center mt-4">
									...
									<div class="mb-3 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
										...
										<!-- Canvas grp4Chart Start -->

										<div id="grp1Chartuebersicht" class="grey-border">

										    <div class="d-flex justify-content-center p-3 bg-white">

										    	<canvas id="grp4Chart" style="max-width: 480px; max-height: 340;"></canvas>

										    </div>

										</div>

										<!-- Canvas grp4Chart Ende -->
									...
									<div class="col d-flex">
										...
										<p class="resultate_info">Die Items <strong>Methodenpluralität, Multimedia / Multimodalität, Medienkompetenz, Differenzierung</strong> und <strong>Barrierefreiheit / Inklusion</strong> zeichnen die <em>mikrodidaktische Fundierung</em> aus. Neben der Variation in der verwendeten Methodik und der Medialität setzt sich dieser Bereich außerdem mit der Förderung der Medienkompetenzen, der Rücksichtnahme auf Heterogenität in der Schülerschaft sowie der Barrierefreiheit beziehungsweise der Inklusion von benachteiligten Gruppierungen auseinander.</p>
							...
							<!-- Ende Container grp4Chart -->							



							<!-- Beginn Container grp5Chart -->

							<div class="container-fluid mt-5 px-xl-5 px-lg-5 px-md-3 px-sm-3 px-xs-1" id="display_grp5Chart">

								<h2 class="font-weight-normal lead-text mb-0"><strong>Kognitive Strukturierung</strong></h2>
								...
								<div class="row justify-content-center mt-4">
									...
									<div class="mb-3 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
										...
										<!-- Canvas grp5Chart Start -->

										<div id="grp1Chartuebersicht" class="grey-border">

										    <div class="d-flex justify-content-center p-3 bg-white">

										    	<canvas id="grp5Chart" style="max-width: 480px; max-height: 340;"></canvas>

										    </div>

										</div>

										<!-- Canvas grp5Chart Ende -->
									...
									<div class="col d-flex">
										...
										<p class="resultate_info">Die Items <strong>Transfer- und Anwendungsorientierung, Prozessorientierung (Kumulation)</strong> und <strong>Lernwegunterstützende Elemente (Scaffolding</strong> repräsentieren den Bereich der <em>kognitiven Strukturierung</em>. Im Vordergrund der Ressource steht nicht nur der Transfer sondern auch der kumulative Aufbau von Wissen, Fertigkeiten und Kompetenzen. Lernwegunterstütztende Elemente sind systematisch an entsprechenden Schlüsselstellen des Lehr- und Lernmittels aufzufinden.</p>
							...
							<!-- Ende Container grp5Chart -->							


							<!-- Beginn Container grp6Chart -->

							<div class="container-fluid mt-5 px-xl-5 px-lg-5 px-md-3 px-sm-3 px-xs-1" id="display_grp6Chart">

								<h2 class="font-weight-normal lead-text mb-0"><strong>Bild- und Textkomposition</strong></h2>
								...
								<div class="row justify-content-center mt-4">
									...
									<div class="mb-3 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
										...
										<!-- Canvas grp6Chart Start -->

										<div id="grp1Chartuebersicht" class="grey-border">

										    <div class="d-flex justify-content-center p-3 bg-white">

										    	<canvas id="grp6Chart" style="max-width: 480px; max-height: 340;"></canvas>

										    </div>

										</div>

										<!-- Canvas grp6Chart Ende -->
									...
									<div class="col d-flex">
										...
										<p class="resultate_info">Die Items <strong>Sprachlichkeit, Bildsprache</strong> beziehungsweise <strong>Additive Kommunikation (Anreicherung)</strong> lassen sich zum Bereich der <em>Bild- und Textkomposition</em> vereinen. Direkte, klare Formulierungen, ergänzende bildliche sowie zusätzliche Elemente runden das Lehr- und Lernmittel professionell ab.</p>
							...
							<!-- Ende Container grp6Chart -->
							


							<!-- Beginn Container grp7Chart -->

							<div class="container-fluid mt-5 px-xl-5 px-lg-5 px-md-3 px-sm-3 px-xs-1" id="display_grp7Chart">

								<h2 class="font-weight-normal lead-text mb-0"><strong>Aufgabendesign</strong></h2>
								...
								<div class="row justify-content-center mt-4">
									...
									<div class="mb-3 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
										...
										<!-- Canvas grp7Chart Start -->

										<div id="grp1Chartuebersicht" class="grey-border">

										    <div class="d-flex justify-content-center p-3 bg-white">

										    	<canvas id="grp7Chart" style="max-width: 480px; max-height: 340;"></canvas>

										    </div>

										</div>

										<!-- Canvas grp7Chart Ende -->
									...
									<div class="col d-flex">
										...
										<p class="resultate_info">Die Items <strong>Sequenzierung, Aktivierung</strong> und <strong>Multiple Lösungswege</strong> befassen sich mit der sinnvollen didaktischen oder fachlichen Abstimmung der Aufgaben, der lernpsychologischen Aktivierung der bearbeitenden Person sowie der Möglichkeit unterschiedliche Lösungswege zur Klärung eines Sachverhalts zu nutzen.</p>
							...
							<!-- Ende Container grp7Chart -->



							<!-- Beginn Container grp8Chart -->

							<div class="container-fluid mt-5 px-xl-5 px-lg-5 px-md-3 px-sm-3 px-xs1" id="display_grp8Chart">

								<h2 class="font-weight-normal lead-text mb-0"><strong>Anwendungstransparenz</strong></h2>
								...
								<div class="row justify-content-center mt-4">
									...
									<div class="mb-3 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
										...
										<!-- Canvas grp8Chart Start -->

										<div id="grp1Chartuebersicht" class="grey-border">

										    <div class="d-flex justify-content-center p-3 bg-white">

										    	<canvas id="grp8Chart" style="max-width: 480px; max-height: 340;"></canvas>

										    </div>

										</div>

										<!-- Canvas grp8Chart Ende -->
									...
									<div class="col d-flex">
										...
										<p class="resultate_info">Der Bereich der <em>Anwendungstransprenz</em> setzt sich aus den Items <strong>Didaktisches Konzept</strong> und <strong>Rahmenbedingungen</strong> zusammen. Die vorliegende Kategorie klärt, ob das Lehr- und Lernmittel Informationen über dessen didaktische Konzeption sowie über dessen Rahmenbedingungen, wie etwa den zeitlichen Umfang oder die technischen Voraussetzungen, enthält.</p>
						          ...
						          <div id="pdfChartuebersicht">
						            ...
						            <div class="d-flex justify-content-center mt-1 mb-5 p-3">
										...
										<div class="p-md-5 p-lg-5 m-md-3 m-lg-5 text-center">
											...
											<p class="font-weight-normal lead-text mt-5 pt-xs-1 pt-sm-1 pt-md-5 pt-lg-5 m-xs-1 m-sm-3 px-xs-1 px-sm-1 px-md-3 px-lg-3">Ihre Daten als <strong>Download</strong> im PDF-Format</p>
											<p class="resultate_info lead-text px-xs-1 px-sm-1 px-md-3 px-lg-3">Sie können Ihre Daten lokal sichern, um dauerhaft auf Ihre Ergebnisse zuzugreifen.</p>

							            	<!-- Start: Button PDF-Download -->

											<button id="downloadBtn" class="btn btn-green btn-pdf">Download als Pdf</button>

											<!-- Ende: Button PDF-Download -->
...
// Start: Buttons als Display-Event

// Start: Darstellung Übersicht
...
function make_dashboard() {
    ...
    $("#button_display_overallChart").click(function () {
        $("#display_thanks").css("display", "none");
        $("#display_overallChart").css("display", "block");
        $("#display_grp1Chart").css("display", "none");
        $("#display_grp2Chart").css("display", "none");
        $("#display_grp3Chart").css("display", "none");
        $("#display_grp4Chart").css("display", "none");
        $("#display_grp5Chart").css("display", "none");
        $("#display_grp6Chart").css("display", "none");
        $("#display_grp7Chart").css("display", "none");
        $("#display_grp8Chart").css("display", "none");
        $("#display_PDF").css("display", "none");
        $("#display_JSON").css("display", "none");
        display_Name();
        display_Link();
        display_Date();
    });

// Ende: Darstellung Übersicht

// Start: grp1Chart Übersicht

    $("#button_display_grp1Chart").click(function () {
        $("#display_thanks").css("display", "none");
        $("#display_overallChart").css("display", "none");
        $("#display_grp1Chart").css("display", "block");
        $("#display_grp2Chart").css("display", "none");
        $("#display_grp3Chart").css("display", "none");
        $("#display_grp4Chart").css("display", "none");
        $("#display_grp5Chart").css("display", "none");
...
// Ende: grp1Chart Übersicht

// Start: grp2Chart Übersicht

    $("#button_display_grp2Chart").click(function () {
        $("#display_thanks").css("display", "none");
        $("#display_overallChart").css("display", "none");
        $("#display_grp1Chart").css("display", "none");
        $("#display_grp2Chart").css("display", "block");
        $("#display_grp3Chart").css("display", "none");
        $("#display_grp4Chart").css("display", "none");
        $("#display_grp5Chart").css("display", "none");
        $("#display_grp6Chart").css("display", "none");
...
// Ende: grp2Chart Übersicht

// Start: grp3Chart Übersicht

    $("#button_display_grp3Chart").click(function () {
        $("#display_thanks").css("display", "none");
        $("#display_overallChart").css("display", "none");
        $("#display_grp1Chart").css("display", "none");
        $("#display_grp2Chart").css("display", "none");
        $("#display_grp3Chart").css("display", "block");
        $("#display_grp4Chart").css("display", "none");
        $("#display_grp5Chart").css("display", "none");
        $("#display_grp6Chart").css("display", "none");
        $("#display_grp7Chart").css("display", "none");
...
// Ende: grp3Chart Übersicht

// Start: grp4Chart Übersicht

    $("#button_display_grp4Chart").click(function () {
        $("#display_thanks").css("display", "none");
        $("#display_overallChart").css("display", "none");
        $("#display_grp1Chart").css("display", "none");
        $("#display_grp2Chart").css("display", "none");
        $("#display_grp3Chart").css("display", "none");
        $("#display_grp4Chart").css("display", "block");
        $("#display_grp5Chart").css("display", "none");
        $("#display_grp6Chart").css("display", "none");
        $("#display_grp7Chart").css("display", "none");
        $("#display_grp8Chart").css("display", "none");
...
// Ende: grp4Chart Übersicht

// Start: grp5Chart Übersicht

    $("#button_display_grp5Chart").click(function () {
        $("#display_thanks").css("display", "none");
        $("#display_overallChart").css("display", "none");
        $("#display_grp1Chart").css("display", "none");
        $("#display_grp2Chart").css("display", "none");
        $("#display_grp3Chart").css("display", "none");
        $("#display_grp4Chart").css("display", "none");
        $("#display_grp5Chart").css("display", "block");
        $("#display_grp6Chart").css("display", "none");
        $("#display_grp7Chart").css("display", "none");
        $("#display_grp8Chart").css("display", "none");
        $("#display_PDF").css("display", "none");
...
// Ende: grp5Chart Übersicht

// Start: grp6Chart Übersicht

    $("#button_display_grp6Chart").click(function () {
        $("#display_thanks").css("display", "none");
        $("#display_overallChart").css("display", "none");
        $("#display_grp1Chart").css("display", "none");
        $("#display_grp2Chart").css("display", "none");
        ...
        $("#display_grp4Chart").css("display", "none");
        $("#display_grp5Chart").css("display", "none");
        $("#display_grp6Chart").css("display", "block");
        $("#display_grp7Chart").css("display", "none");
        $("#display_grp8Chart").css("display", "none");
        $("#display_PDF").css("display", "none");
        $("#display_JSON").css("display", "none");
...
// Ende: grp6Chart Übersicht

// Start: grp7Chart Übersicht

    $("#button_display_grp7Chart").click(function () {
        $("#display_thanks").css("display", "none");
        $("#display_overallChart").css("display", "none");
        $("#display_grp1Chart").css("display", "none");
        $("#display_grp2Chart").css("display", "none");
        ...
        $("#display_grp5Chart").css("display", "none");
        $("#display_grp6Chart").css("display", "none");
        $("#display_grp7Chart").css("display", "block");
        $("#display_grp8Chart").css("display", "none");
        $("#display_PDF").css("display", "none");
        $("#display_JSON").css("display", "none");
    });

// Ende: grp7Chart Übersicht

// Start: grp8Chart Übersicht

    $("#button_display_grp8Chart").click(function () {
        $("#display_thanks").css("display", "none");
        $("#display_overallChart").css("display", "none");
        $("#display_grp1Chart").css("display", "none");
        $("#display_grp2Chart").css("display", "none");
        ...
        $("#display_grp6Chart").css("display", "none");
        $("#display_grp7Chart").css("display", "none");
        $("#display_grp8Chart").css("display", "block");
        $("#display_PDF").css("display", "none");
        $("#display_JSON").css("display", "none");
    });

// Ende: grp8Chart Übersicht

// Start: PDF

    $("#button_display_PDF").click(function () {
        $("#display_thanks").css("display", "none");
        $("#display_overallChart").css("display", "none");
        $("#display_grp1Chart").css("display", "none");
        $("#display_grp2Chart").css("display", "none");
...
// Start: JSON
    ...
    $("#button_display_JSON").click(function () {
        $("#display_thanks").css("display", "none");
        $("#display_overallChart").css("display", "none");
        $("#display_grp1Chart").css("display", "none");
        $("#display_grp2Chart").css("display", "none");
        ...
        $("#display_grp8Chart").css("display", "none");
        $("#display_PDF").css("display", "none");
        $("#display_JSON").css("display", "block");
    });

// Ende: JSON

// Ende: Buttons als Display-Event


// Start: Übersicht - Ergänzende Informationen

// Start: Display - Name Lehr- Lernmittel

    function display_Name() {
        console.log("Name:" + survey.getValue('Name'));
        document.getElementById('name_lernmittel').innerHTML = survey.getValue('Name');
    }

// Ende: Display - Name Lehr- Lernmittel

// Start: Display - Link Lehr- Lernmittel

    function display_Link() {
        if (survey.getValue('Verlinkung') === "") {
            survey.setValue('Verlinkung', 'Keine Angabe');
            $("#link_lernmittel").prop('href', "#");
        } else {
            $("#link_lernmittel").prop('href', survey.getValue('Verlinkung'));
        }
        document.getElementById('link_lernmittel').innerHTML = survey.getValue('Verlinkung');
    }

// Ende: Display - Link Lehr- Lernmittel
...
// Start: Display - Datum
    ...
    function display_Date() {
        ...
        document.getElementById('datum_lernmittel').innerHTML = output;

    }

// Ende: Display - Datum

// Ende: Übersicht - Ergänzende Informationen


// Start: Trigger für Dashbaord-Menü
...
// Ende: Trigger für Dashbaord-Menü
